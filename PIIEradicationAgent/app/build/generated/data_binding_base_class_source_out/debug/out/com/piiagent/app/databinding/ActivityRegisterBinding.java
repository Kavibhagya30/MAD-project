...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull NestedScrollView rootView, @NonNull ImageButton btnBack,
      @NonNull Button btnRegister, @NonNull TextInputLayout tilConfirmPassword,
      ...
      @NonNull TextView txtGoLogin, @NonNull TextView txtSubtitle, @NonNull TextView txtTitle) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txtGoLogin;
      TextView txtGoLogin = ViewBindings.findChildViewById(rootView, id);
      if (txtGoLogin == null) {
        break missingId;
      }
      ...
      return new ActivityRegisterBinding((NestedScrollView) rootView, btnBack, btnRegister,
          tilConfirmPassword, tilEmail, tilFullName, tilPassword, tilPhone, txtGoLogin, txtSubtitle,
          txtTitle);
    }
